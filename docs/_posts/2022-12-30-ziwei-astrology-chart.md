...
北斗系按顺序分别为：紫薇（星主，北极星）、贪狼、巨门、禄存、文曲、廉贞、武曲和破军（北斗七星）； 
南斗系按顺序分别为：天府（星主）、天梁、天机、七杀、天相和天同（紫微斗数中，文昌被认为是南斗中的一颗，但南斗系仅有前六颗星）。
其中北斗七星中第三、四星，禄存和文曲，南斗系的文昌，均不入正曜之列。如果按照星曜的影响力来分类，十四正曜属于甲级星，其影响力最大。
...
推算**流月命宫**，是以**流年斗君**所在宫位为正月命宫，顺时针排列流月命宫。例如寅年斗君在申，则寅年正月在申宫。
又例，子年斗君在午，则丑年斗君排在未，因些丑年正月便以未宫起宫，依此类推。

我们已知，但生年四化星（基本盘）以**生年干**为依据，而流年四化星系以**流年干**为依据，这里，
流月四化星以**流月干**来决定。例如某命流年乙丑年三月，假设子年斗君在午，则丑年斗君在未宫起正月，申二月，
酉三月，流月命宫在酉。但天干则以乙年（「五虎遁月诀」中「**乙庚之岁戊为头**」，也就是干支纪月）起戊寅（正月）、己卯（二月）、庚辰（三月）。
故推命时流月之命排在酉宫，但流月四化按庚辰月算，即「**庚阳武府同**」。

### 流日命宫、干支纪日

流日推算法是以流月（当月命）宫位起初一，顺数回命宫为十三、廿五等。例如三月在酉宫，则三月十五日在亥宫，因三月初一在酉，
初二在戌，初三在亥，……，顺至十三在酉，十四在戌，十五在亥宫。流日当天所在的位置就是**流日命宫**。
如果当天是一月三日，那一月初三的位置就是流日命宫，一样可以排列出另外十一个宫位，排出流日的命盘。

现行农历置闰，每隔两年到三年，就必须增加一个与上一个月相同的农历月份，增加的这个月叫**闰月**。
闰月是因为太阳和月亮相对地球转动的周期不是整天数造成的。如遇闰月，则闰月以前半月属上月，下半月属下月推算（注：有些派别则统归下月）。
例如三月有闰月，则三月顺数卅日后加上闰月前半月之十五日，共四十五日顺推，四月也是另起初一后，以四十五日顺推。

干支纪日用60组各不相同的干支进行标注。从甲子到癸亥，不断循环记录。纪日的干支组合可称为**日柱**。
...
$$日干支序数= (年数+月数+日期) \bmod 60 $$

注：1月和2月并入上一年，可以将1月看作上一年的13月，2月看作上一年的14月，1月和2月仍用上一年的年数，
不可用当年的年数。把3月置为每年首月算起。年数适用范围：此年3月至下年2月。

例：分别求出1986年7月18日，2000年8月15日，和2008年1月15日干支？

解：查表得知，1986年数40，2000年数54，2008年1月15日，未满3月，属于上一年2007年数30，

$$\begin{aligned}
 1986年7月18日 &: 1986年数+7月数+18日=40+2+18=60=癸亥  \\
 2000年8月15日 &: 2000年数+8月数+15日=54+33+15=60+42=乙巳\\
 2007年1月15日 &: 2007年数+1月数+15日=30+6+15=51=甲寅
\end{aligned}$$

### 流时命宫，干支纪时

流时推算法是以流日（当日命）宫位起子时，顺数至亥时，流时四化以流时的干支算。出生时辰的干支就是八字中的**时柱**，
时辰的干支大多万年历上没有，需根据其出生日的天干来推算时辰干支，称为**干支纪时**。

**五虎遁法**用来推演干支纪月中的月干，在**[「起寅首」](#ref02a)**的章节中已经介绍过，年干是从甲开始，
月支是从子开始，每年的正月从寅月开始，二月为卯月，……，以此类推。但子月还是前一年的冬天、又叫冬月，
立春以后就是寅月；**五鼠遁法**用来推演干支纪时中的时干，日干是从甲开始，每天的十二个时辰的时支是从子开始。
...
（即按十日干排位数：1甲、2乙、3丙、4丁、5戊、6己、7庚、8辛、9壬、10癸）
例如：日干为己的时候，$$(6\times2-1) \bmod 10 = 1$$，1是甲，子时从甲起。
又例：日干为戊的时候，$$(5\times2-1) \bmod 10 = 9$$，9是壬，子时就是壬子。其它类推。

阳历2008年1月15号，凌晨3点至5点（阴历2007年12月8号，丁亥年腊月初八寅时）出生的人的四柱，计算如下：

**年柱**：$$年干=(2007-3) \bmod 10 = 4 = 丁$$，$$年支 = (2007-3) \bmod 12 = 0 = 亥$$，
或者根据干支表得$$年干支=(2007-3) \bmod 60 = 24 = 丁亥$$。得年柱为**丁亥**。

**月柱**：腊月月支为丑，根据**五虎遁法**，查表可知年干“丁”对应为正月干支为壬寅，或者根据公式计算出，
寅月的月干数为“壬”，向前退一个月为腊月，因此腊月的月干数为“癸”，月柱为**癸丑**。

**日柱**：在以前得举例中已算得日柱为**甲寅**；

**时柱**：已知生时支为寅，根据**五鼠遁法**，查表可知日干“甲”对应子时干支为甲子，或者根据公式计算出，
子时的时干数为$$日干=1\times2-1 \bmod 10 = 1 = 甲$$，向前进三个时辰为寅时，因此寅时的时干数为“丙”，
时柱为**丙寅**。
...
+ 辅曜：左辅右弼天魁天钺
+ 佐曜：文昌文曲禄存天马
+ 煞曜：擎羊、陀罗、火星、铃星称为四凶，四煞，加上地空、地劫，称为六煞
+ 空劫：地空地劫
+ 化曜：化禄，化权，化科，化忌
+ 三奇：指化禄、化权、化科也称为三吉化
+ 四吉星：禄（禄存、化禄），贵（天魁、天钺），权（化权），科（化科）
...
+ 十天干：甲、丙、戌、庚、壬属阳。属该天千年出生之人属阳命。乙、丁、已、辛、癸属阴。该年出生之人属阴命。

	||甲、乙|丙、丁|戊己|庚辛|壬癸|
	|:--:|:--:|:--:|:--:|:--:|:--:|
	|五行属性|木|火|土|金|水|
+ 十二地支：地支共十二个，分属金、木、水、火、土五行，只有土占四，即辰、戌、丑、未称为四墓库，其分别如下：
...
+ 地支六合：十二地支分成六组，每组有两个不同五行的地支，合而为一化气属另一五行，只有「午」与「未」二个地支化合之后不属五行，以「午」为太阳，「未」为太阴。这样的组合，即称为“地支六合”。

	|地支|子 丑|寅 亥|卯 戌|辰 酉|巳 申|午|未|
	|:--:|:--:|:--:|:--:|:--:|:--:|
	|化合|土|木|火|金|水|太阳|太阴|

+ 地支六冲：十二地支有六合，也有六冲，紫微斗数中之六冲和「子平」不同。子平术中，凡对宫必相冲，如子午、丑未之类，六冲有破坏的意义。斗数推查命盘的吉凶，要查看三方四正，所谓三方就是地支三会局。
而四正便是本宮和对宫。当星曜于「三方四正」会合之时，都称之为「冲」，不限于本宮和对宫的相冲而已。斗数中无论吉星或凶星，于推算流运时，不冲不动，即吉星不成其吉，凶星亦不成其凶。

+ 地支三会局：十二地支相隔三宫位置会合，可组成一局，全盘共四局，每局亦即是紫微斗数中所谓三方四正的「三方」。「三方」组成一局，亦即是「生旺墓」的组合，如水局申为长生、子为帝旺、辰为墓库之类。
...
+ 坐守：正曜入躔(chán)本宫，称为坐守。如命宫有七杀正曜，称为七杀坐守命宫，或简称七杀守命。
+ 同度：星曜同躔一宫。如除七杀坐守外，宫内又见禄存，则称为禄存同度。
+ 加会：指本宫、对宫、三合宫中的某些星曜会合而言。本宫、对宫、三合宫可视为一个整体进行论断，此点尤其在推断命宫吉凶时，就显得分外重要。
+ 拱照：星曜见于对宫。如七杀坐守，对宫紫微天府，称为紫府拱照。有时又称朝拱。
+ 守照：某星坐于本宫曰守，照指本宫之三合宫及对宫之星曜与本宫所发生之感应。
+ 会照：星曜见于三合宫。如七杀在申宫坐守，贪狼坐辰，破军坐子，故称为贪破会照。
+ 相夹：两星曜位于本宫的邻宫，称为相夹。如寅宫武曲化忌，擎羊在卯，陀罗在丑，即为羊陀夹忌。
+ 见：凡星曜会合于三方四正，统称为见。
+ 冲：凡煞忌诸曜见于三方四正，称为冲，斗数的冲，跟“子平”的六冲不同。有时亦称为冲破。
...
2. 天干地支阴、阳、五行属性
    ...
    干支奇数为阳，偶数为阴，阴配阴，阳配阳。天干五行：甲乙木、丙丁火、戊己土、庚辛金、壬癸水；地支五行：寅卯木、巳午火、申酉金、亥子水、辰戌丑未土。
	因此五行属性也分阴阳，且有口诀可循（略）。五行属性不同于纳音五行局，而是用来推算干支的合、冲、刑、害、会：
	天干五合、地支六合、地支三合、地支六冲、地支相刑、地支六害、地支三会（略）。

3. 安命身宫，天干五虎遁，定五行局，起大限

    起寅宫，顺数生月逆数生时定命宫，顺数生月顺数生时定身宫，以命宫逆时针布命迁十二宫。
	以年柱之天干，依《五虎遁决》（或公式）起寅首（定寅宫的宫干），从寅宫依次排满十二宫的宫干（此时可知生月之月柱）。
	以命宫的干支（纪月），依《纳音五行速查表》（或公式）推算纳音五行局。
	以年柱之天干，定男女之阴阳，由命宫起，依局数，阳男阴女顺行；阴男阳女逆行，每十年过一宫限，起大限。
4. 起紫微星的方法，十二基本盘的排布

    以农历生日和纳音五行局，依口诀（或公式）推算紫薇星的宫位；天府星和紫微星永远关于寅–申线对称。
	此时即可安十四正曜，紫薇系逆时针，天府系顺时针，一共十二种组合。
5. 四化表，尤其重要

    禄、权、科、忌以出生年柱之天干，依口诀或查表。
6. 安左辅右弼天魁天钺文昌文曲的方法

    天魁天钺依年干系诸星（出生年柱之天干）口诀或查表，左辅右弼依月系诸星（生月数）口诀或查表，文昌文曲依时系诸星（生时数）口诀或查表。
7. 安禄存天马擎羊陀罗地空地劫火星铃星的方法

    禄存擎羊陀罗依年干系诸星（出生年柱之天干）口诀或查表，天马依年支系诸星（出生年柱之地支）口诀或查表，
	地空地劫依时系诸星（生时数）口诀或查表。火星铃星虽是时系诸星，但是要结合出生年柱之地支和依时系诸星（生时数）口诀或查表。
8. 安斗君的方法

    子年斗君以子宫起正月，依口诀逆数生月、顺数生时或查表，流年斗君则以以流年命宫起正月，依口诀或查表。

## 天盘、地盘和人盘

先依「安星法」排好命盘，这命盘即称为「天盘」。将天盘的**身宫**改作为命宫，并用身宫的**干支**来推定五行局，
安紫微及天府，如是得出来的命盘即称为「地盘」。若不用身宫，而将天盘**福德宫**改作命宫，
并用福德宫**干支**来推定五行局及安紫府，得出来的命盘即称为「人盘」。更正确的叫法，是「地盘之人盘」。
